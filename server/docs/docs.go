    ...
    "paths": {
        ...
        "/cart": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "現在のカート内容（商品リスト、合計情報）を取得"
                    }
                }
            }
        },
        "/cart/items": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "SKU ID,Quantity",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.ItemQuantityRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "指定したSKUと数量をカートに追加（または更新）"
                    }
                }
            }
        },
        "/cart/items/{skuId}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "カート内の指定SKUの数量を変更する"
                    }
                }
            },
            "delete": {
        ...
        "/categories/tree": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "全カテゴリの階層構造リスト（ナビゲーション用）を取得する"
                    }
                }
            }
        },
        "/categories/{categoryId}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "include_product_count",
                ...
                "responses": {
                    "200": {
                        "description": "指定されたカテゴリIDまたはコードの情報を取得（サブカテゴリ、関連属性等"
                    }
                }
            }
        },
        ...
        "/favorites/skus": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "1ページあたりのレビュー件数",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "ソート順序('newest', 'oldest'のいずれかを指定",
                        "name": "sort",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "自身のお気に入りSKUリストを取得する"
                    }
                }
            },
            "post": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.SkuIdRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "指定したSKUをお気に入りに追加する"
                    }
                }
            }
        },
        "/favorites/skus/{skuId}": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "指定したSKUをお気に入りから削除する"
                    }
                }
            }
        },
        ...
        "/history/viewed-skus": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "自身の最近チェックした商品（SKU）リストを取得する"
                    }
                }
            },
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "閲覧したSKU（代表SKU）を履歴に記録する"
                    }
                }
            }
        },
        ...
        "/orders": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "1ページあたりのQ\u0026A件数",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "特定の注文ステータスで絞り込む場合（例: payment_confirmed,pending_payment, shipped,cancelled,delivered,processing）",
                        "name": "status",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "自身の注文履歴をページネーション付きで取得する"
                    }
                }
            },
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "注文を確定し、Pay.jpテストモードで支払い処理を実行、注文データを保存"
                    }
                }
            }
        },
        "/orders/checkout/apply-coupon": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "クーポン適用APIのリクエストボディ",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ApplyCouponRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "指定クーポンを現在の注文（カート）に適用する"
                    }
                }
            }
        },
        "/orders/checkout/info": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "現在のカート合計等に応じた利用可能クーポン・ポイント情報を取得"
                    }
                }
            }
        },
        "/orders/checkout/remove-coupon": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "適用中クーポンを解除する"
                    }
                }
            }
        },
        "/orders/checkout/remove-points": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "利用中ポイントを解除する"
                    }
                }
            }
        },
        "/orders/checkout/use-points": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "ポイント利用APIのリクエストボディ",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UsePointsRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "指定ポイント数を現在の注文（カート）に利用する"
                    }
                }
            }
        },
        "/orders/{orderId}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "指定した注文IDの詳細情報を取得する"
                    }
                }
            }
        },
        "/payments/methods": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "利用可能な支払い方法の一覧を取得する"
                    }
                }
            }
        },
        "/products/getCoordinates/{productCode}/coordinates": {
            "get": {
                "consumes": [
                    "application/json"
                ],
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "表示するコーディネートセット概要の最大件数",
                        "name": "limit",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "商品コーディネート概要リスト取得"
                    }
                }
            }
        },
        "/products/getImage/{skuId}/images": {
            "get": {
                "consumes": [
                    "application/json"
                ],
                ...
                "responses": {
                    "200": {
                        "description": "SKU画像リスト取得"
                    }
                }
            }
        },
        "/products/getProductInfo/{productCode}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "商品の基本情報と、リクエストで特定されたSKUに関する詳細情報を返す"
                    }
                }
            }
        },
        "/products/getQA/{productCode}/qa": {
            "get": {
                "consumes": [
                    "application/json"
                ],
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "ソート順序('newest', 'oldest', 'most_helpful' のいずれかを指定",
                        "name": "sort",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "紐づく承認済みの質問とそれに対する店舗回答のリストを、ページネーションおよびソート機能付きで取得する"
                    }
                }
            }
        },
        "/products/getRelated/{productCode}/related": {
            "get": {
                "consumes": [
                    "application/json"
                ],
                ...
                "responses": {
                    "200": {
                        "description": "関連商品リスト取得"
                    }
                }
            }
        },
        "/products/getReviews/{productCode}/reviews": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "ソート順序('newest', 'oldest', 'highest_rating', 'lowest_rating', 'most_helpful' のいずれかを指定",
                        "name": "sort",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "指定した評価（星の数、例: 5）",
                        "name": "rating",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "レビューリスト、集計情報、ページネーション情報を返す"
                    }
                }
            }
        },
        "/products/search": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "ソート順例: 'relevance'(関連度順), 'price_asc'(価格安い順), 'price_desc'(価格高い順), 'newest'(新着順)",
                        "name": "sort",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "キーワードとカテゴリ（任意）で商品を検索し、結果をページネーションで返す"
                    }
                }
            }
        },
        "/shipping-addresses": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "自身の登録済み配送先住所リストを取得する"
                    }
                }
            },
            "post": {
                ...
                "parameters": [
                    {
                        "description": "配送先住所入力データ",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ShippingAddressInput"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "新しい配送先住所を登録する"
                    }
                }
            }
        },
        "/shipping-addresses/{addressId}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "指定した配送先住所IDの情報を更新する"
                    }
                }
            },
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "指定した配送先住所IDの情報を削除する"
                    }
                }
            }
        },
        ...
        "/user/deleteLoginHistoryByIdAndTimeRange": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "用户ID和时间范围",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.LoginHistoryRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/user/getLoginHistoryByIdAndTimeRange": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
