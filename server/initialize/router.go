...
func Routers() *gin.Engine {
...

	{
		...
		productsRouter.InitProductsRouter(PublicGroup)
		productsRouter.InitFavoritesRouter(PrivateGroup)
		productsRouter.InitHistoryRouter(PrivateGroup)
		productsRouter.InitCartRouter(PrivateGroup)
